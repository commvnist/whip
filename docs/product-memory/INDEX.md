...
- Declared test-source baseline: **1,414 product tests: 547 JVM and 867 Android**. The complete current baseline was freshly executed for `VER-20260902-003`; the most recent separate continuous E2E coverage campaign remains `VER-20260901-022`.
