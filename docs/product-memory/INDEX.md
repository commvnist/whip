...
- Declared test-source baseline: **1,266 product tests: 514 JVM and 752 Android**. The complete current baseline and E2E coverage campaign were freshly executed for `VER-20260901-017`.
...
- Return to the remaining Gym session/quick-set secondary outcomes under `FND-20260831-019`, preserving exact 5/3/1 programming, active-workout history, Track definition/Entry/CSV boundaries, Goal lifecycle/history, and the verified Habit/Task/recovery/reminder/calendar contracts.
- Schema 39 and portable-backup format 16 preserve orthogonal Goal archive state, immutable closure/reset history, stable merge identity, and private local-only Track CSV receipts without rewriting completed workouts or previously recorded facts. See `DEC-20260831-017`, `DEC-20260901-022`, `IMP-20260901-015`, and `VER-20260901-017`.
