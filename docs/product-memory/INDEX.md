...
- Declared test-source baseline: **1,420 product tests: 549 JVM and 871 Android**. The complete current baseline was freshly executed for `VER-20260902-004`; the most recent separate continuous E2E coverage campaign remains `VER-20260901-022`.
