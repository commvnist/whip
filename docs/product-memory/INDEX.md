...
- Declared test-source baseline: **1,392 product tests: 539 JVM and 853 Android**. The complete current baseline and a separate full E2E coverage campaign were freshly executed for `VER-20260901-022`.
