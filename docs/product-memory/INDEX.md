...
- VERA-Codex is installed globally and in Whip with Luna/Terra/Sol roles, bounded retries/parallelism, deterministic stop gates, and a repository override preserving conventional single-developer work unless the user explicitly requests delegation. See `FB-20260902-002`, `DEC-20260902-012`, `IMP-20260902-013`, and `VER-20260902-013`.
...
- Per `FB-20260902-001` / `DEC-20260902-001`, future Whip work uses a conventional single-developer loop with no subagents, simulated panels, recursive audits, formal debates, or repeated approval rounds unless the user explicitly requests them. The installed VERA roles do not override this repository rule.
