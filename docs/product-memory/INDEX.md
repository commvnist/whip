...
- Declared test-source baseline: **1,307 product tests: 523 JVM and 784 Android**. The complete current baseline and a separate full E2E coverage campaign were freshly executed for `VER-20260901-019`.
...
- Continue with `FND-20260901-026` lightweight Gym reorder/group/removal exactness, preserving the session/5/3/1 contracts from `FND-20260901-025`, then audit `FND-20260901-027` Custom Unit/Health/choice ownership. Preserve Track definition/Entry/CSV boundaries, Goal lifecycle/history, transactional typed Settings, and the verified Habit/Task/recovery/reminder/calendar contracts.
