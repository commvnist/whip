...
- Declared test-source baseline: **1,375 product tests: 532 JVM and 843 Android**. The complete current baseline and a separate full E2E coverage campaign were freshly executed for `VER-20260901-021`.
...
- Continue the remaining risk-proportionate secondary families: bounded shares, progressive Habit UX, named large-text navigation, returning Home, Track search ownership, and whole-product accessibility/platform matrices. Preserve the exact Health/Custom Unit/restore/reset contracts from `FND-20260831-020`, `FND-20260901-027`, and `FND-20260901-028`; the Gym session/5/3/1/structure contracts from `FND-20260901-025` and `FND-20260901-026`; and the verified Track, Goal, typed Settings, Habit, Task, recovery, reminder, and calendar contracts.
