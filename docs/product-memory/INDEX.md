...
- Declared test-source baseline: **1,422 product tests: 550 JVM and 872 Android**. The complete current baseline was freshly executed for `VER-20260902-005`; the most recent separate continuous E2E coverage campaign remains `VER-20260901-022`.
