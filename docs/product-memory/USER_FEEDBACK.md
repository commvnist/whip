...
- Status: Implemented and emulator-accepted; higher-version owner-phone release is in progress.
- Notes: The selected physical target remains the owner-approved Samsung transport used by the prior private releases; transient connection details are not durable product memory. Public Play Store qualification is out of scope.
