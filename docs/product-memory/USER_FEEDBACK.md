...
- Status: Released as Whip 0.3.72/code 78 under IMP/VER-20260915-002. Exact-alarm wakeup, denied-access fallback, five independent minute-spaced Habit claims, late-delivery succession, lifecycle rebuild/cancellation, 31 neighboring Android reminder/recovery tests, and the 661-JVM readiness gate pass. The signed in-place owner-phone update preserves installation identity and data, matches the verified APK hash, has precise-alarm access allowed and passes foreground/process/runtime health checks.
