...
- Status: Partially resolved. Habit is verified in `IMP-20260831-009` / `VER-20260831-011`, Task in `IMP-20260831-010` / `VER-20260831-012`, Goal in `IMP-20260831-011` / `VER-20260831-013`, Gym Exercise/Routine deletion in `IMP-20260901-012` / `VER-20260901-014`, completed-Workout deletion in `IMP-20260902-011` / `VER-20260902-011`, Track definition/direct/CSV in `IMP-20260901-013` through `IMP-20260901-015`, Gym active-session/quick-set and remaining structure mutations in `IMP-20260901-016` / `VER-20260901-018` and `IMP-20260901-018` / `VER-20260901-020`, typed Settings in `IMP-20260901-017` / `VER-20260901-019`, Custom Unit/Health/backup/reset integrity in `IMP-20260901-019` / `VER-20260901-021`, external Task launch/share handoff in `IMP-20260901-020` / `VER-20260901-022`, Area management in `IMP-20260902-009` / `VER-20260902-009`, and Tag management in `IMP-20260902-010` / `VER-20260902-010`. Other secondary families still require separate risk-proportionate review.
