...
- Status: Partially resolved. Habit is verified in `IMP-20260831-009` / `VER-20260831-011`, Task in `IMP-20260831-010` / `VER-20260831-012`, Goal in `IMP-20260831-011` / `VER-20260831-013`, Gym permanent deletion in `IMP-20260901-012` / `VER-20260901-014`, Track definition/direct/CSV in `IMP-20260901-013` through `IMP-20260901-015`, and the Gym active-session/quick-set subset in `IMP-20260901-016` / `VER-20260901-018`. Remaining lightweight Gym reorder/group/removal actions and unrelated Settings/share families still require separate risk-proportionate review.
