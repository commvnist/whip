...
| --- | --- | --- | --- |
| First run and recovery | FirstRunSetupDialog/Host, SettingsViewModel, StartupRecoveryScreen, DataEpochGate, launch and recovery | In progress | Confirmed save/layout and selected Home priority verified in IMP/VER-20260909-004/005; dialog contrast and complete recovery review remain open |
...
7. `FND-20260909-004` remains confirmed: separate dialog windows still need theme contrast ownership. `FND-20260909-005` is verified in `IMP/VER-20260909-005`: empty Home now leads with selected sections in saved order while preserving every tool's discovery/action. Six focused and 18 adjacent Android tests, 344 JVM readiness tests, and 39 fresh shared captures pass; [selected/all-section Home evidence](../../artifacts/astra-audit/2026-09-09/home-priority/README.md).
...
- First-run customization, optional preferences, pending/failure, actual 200% text/RTL, and setup-to-Home now have explicit evidence. Eight additions expand the current catalog/matrix to 201 states; selected Home priority is verified, while dialog-window contrast and broader adaptive/accessibility review remain pending.
