...
| --- | --- | --- | --- |
| First run and recovery | FirstRunSetupDialog/Host, SettingsViewModel, StartupRecoveryScreen, DataEpochGate, launch and recovery | In progress | Confirmed save/retry/recreation/permission timing and content-sized layout verified in IMP/VER-20260909-004; dialog contrast, empty-Home priority, and complete recovery review remain open |
...
7. `FND-20260909-004` / `FND-20260909-005` remain confirmed: separate dialog windows still need theme contrast ownership; empty Home prioritizes Tasks/Habits even after the user chooses Tracks/Gym. Preserve all-tool discoverability when correcting that starting priority.
...
- First-run customization, optional preferences, pending/failure, actual 200% text/RTL, and setup-to-Home now have explicit evidence. Eight additions expand the current catalog/matrix to 201 states; this does not close the separate dialog-window or Home-priority findings.
