...
Current baseline: 696 product tests—326 fast JVM tests and 370 Android
...
| Internal persistence and forward-compatible upgrades | checked-in pre-release schemas 1–9 and public schemas 27–29, all forward to 30 | `WhipDatabaseMigrationTest` preserves schema-1 Tasks/Links/Contributions/Automations, schema-2 Tracks, schema-9 current-domain state, schema-27 public entity-tag/Goal-snapshot data, schema-28 checklist Habits, and schema-29 Gym tracking data through schema 30; it also defaults upgraded checklist Habits to final-item auto-completion and converts legacy Habit Skip/Excuse rows without retaining false measurements. `PersistentStorageE2ETest` closes and reopens a file-backed DB | signed public-0.3.7 APK upgrade retains a populated sentinel; `CoreFeatureJourneyE2ETest` recreates the Activity |
