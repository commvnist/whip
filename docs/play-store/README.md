...
The listing-ready captures in `screenshots/` are native 1080×1920 PNGs
showing Whip's core modules, including first-class Tracks, with representative local-only
