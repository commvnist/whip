...
states={'settings.item-builder.choice-value','settings.item-builder.saved-value','settings.index','settings.appearance','settings.planning','settings.organization','settings.reminders','settings.data-privacy','settings.about-diagnostics'}
seen=set();records=[]
